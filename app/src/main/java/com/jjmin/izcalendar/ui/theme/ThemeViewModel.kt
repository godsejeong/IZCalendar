...
class ThemeViewModel(private val usecase: ThemeUseCase) : ViewModel(){
    ...
    init {
        btnbl.set(false)
            baselist.apply {
            add(ThemeItem(usecase.activity.applicationContext.resources.getDrawable(R.drawable.bg_youngone),"원영",R.color.colorOneYoung,R.color.colorOneYoungBg))
            ...
            add(ThemeItem(usecase.activity.applicationContext.resources.getDrawable(R.drawable.bg_nako),"나코",R.color.colorNaco,R.color.colorNacoBg))
