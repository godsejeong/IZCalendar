...
class ThemeViewModel(private val usecase: ThemeUseCase) : ViewModel(){
    ...
    init {
        btnbl.set(false)
            baselist.apply {
            add(ThemeItem(usecase.activity.applicationContext.resources.getDrawable(R.drawable.bg_oneyoung),"원영",R.color.colorOneYoung,R.color.colorOneYoungBg))
            add(ThemeItem(usecase.activity.applicationContext.resources.getDrawable(R.drawable.bg_sakura),"사쿠라",R.color.colorSakura,R.color.colorSakuraBg))
            add(ThemeItem(usecase.activity.applicationContext.resources.getDrawable(R.drawable.bg_yuri),"유리",R.color.colorYuRi,R.color.colorYuRiBg))
            add(ThemeItem(usecase.activity.applicationContext.resources.getDrawable(R.drawable.bg_yena),"예나",R.color.colorYeNa,R.color.colorYeNaBg))
            add(ThemeItem(usecase.activity.applicationContext.resources.getDrawable(R.drawable.bg_yujin),"유진",R.color.colorYuJin,R.color.colorYuJinBg))
            add(ThemeItem(usecase.activity.applicationContext.resources.getDrawable(R.drawable.bg_naco),"나코",R.color.colorNaco,R.color.colorNacoBg))
            ...
            add(ThemeItem(usecase.activity.applicationContext.resources.getDrawable(R.drawable.bg_hyeone),"혜원",R.color.colorHyeWon,R.color.colorHyeWonBg))
            ...
            add(ThemeItem(usecase.activity.applicationContext.resources.getDrawable(R.drawable.bg_chaewon),"채원",R.color.colorChaeWon,R.color.colorChaeWonBg))
